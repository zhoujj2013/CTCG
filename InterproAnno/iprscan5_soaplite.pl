...
iprscan5_soaplite.pl

=head1 DESCRIPTION

InterProScan 5 (SOAP) web service Perl client using L<SOAP::Lite>.
...
$Id: iprscan5_soaplite.pl 2790 2014-05-29 15:18:24Z hpm $
...
sub get_agent_string {
	...
	my $clientVersion = '0';
	if('$Revision: 2790 $' =~ m/(\d+)/) { # SCM revision tag.
		$clientVersion = $1;
	}
